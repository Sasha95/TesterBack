...
/*
	...
	/*		//add branch data to table
			...
			var ans1 = new Answer() { Id = 1, AnswerText = "1799", Realy = true };
			var ans2 = new Answer() { Id = 2, AnswerText = "1123", Realy = false };
			var ans3 = new Answer() { Id = 3, AnswerText = "13799", Realy = false };
			var ans4 = new Answer() { Id = 4, AnswerText = "179", Realy = false };

			var Nosorog_ASS = new List<Answer>() { ans1, ans2, ans3, ans4 };
			

			modelBuilder.Entity<Question>().HasData(new Question() { Id = 1, QuestionText = "Год рождения Пушкина А.С.", Answers = Nosorog_ASS });
			...
			//modelBuilder.Entity<Session>().HasData(new Session() { Id = 1, Test = null, UserId = 1 }) ;
